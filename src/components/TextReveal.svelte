...
<div bind:this={val.ref} class="scroller w-fit">
	<div class={cn('inner relative z-10 ', className)}>
		<div class="sticky top-0 h-[30%] max-w-xl items-center bg-transparent px-[1rem] py-[5rem]">
			<p
				class="flex flex-wrap p-5 text-2xl font-bold text-black/20 md:p-8 md:text-3xl lg:text-4xl xl:text-5xl dark:text-white/20"
			>
